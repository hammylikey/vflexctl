...
GET_LED_STATE_SEQUENCE: CommandList = prepare_command_for_sending(
    prepare_subcommand_frame([GET_LED_STATE_COMMAND])
)

GET_VOLTAGE_SEQUENCE: CommandList = prepare_command_for_sending(
    prepare_subcommand_frame([GET_VOLTAGE_COMMAND])
)